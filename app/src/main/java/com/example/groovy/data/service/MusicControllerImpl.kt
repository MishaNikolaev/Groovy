package com.example.groovy.data.service
...
class MusicControllerImpl(context: Context) : MusicController {
    ...
    private var mediaControllerFuture: ListenableFuture<androidx.media3.session.MediaController>
    ...
    override fun destroy() {
        androidx.media3.session.MediaController.releaseFuture(mediaControllerFuture)
